! function(t, e) {
    ...
    function g(t, e) {
        ...
        n = '"'.concat(t, '" is deprecated and will be removed in the next major release. Please use "')
            .concat(e, '" instead.'), -1 === Z.indexOf(n) && (Z.push(n), K(n))
    }
    function v(t) {
    ...
    function _(e, t) {
        var n;
        e.textContent = "", t && (n = (new DOMParser)
            .parseFromString(t, "text/html"), h(n.querySelector("head")
                .childNodes)
            .forEach(function(t) {
                e.appendChild(t)
            }), h(n.querySelector("body")
                .childNodes)
            .forEach(function(t) {
                e.appendChild(t)
            }))
    ...
    function z(t, e, n) {
        ...
        if (i = e, h((o = t)
            ...
            .forEach(function(t) {
                -1 === m(J)
                    .indexOf(t) && -1 === m(X)
                    .indexOf(t) && -1 === m(i.showClass)
                    .indexOf(t) && o.classList.remove(t)
            }), e.customClass && e.customClass[n]) {
            if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach) return K("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "')
    ...
    function ht(t, e) {
        ...
        e.showConfirmButton || e.showDenyButton || e.showCancelButton || at(n), z(n, e, "actions"), At(i, "confirm", e), At(r, "deny", e), At(a, "cancel", e), o.innerHTML = e.loaderHtml, e.buttonsStyling ? function(t, e, n, o) {
            ...
            o.cancelButtonColor && (n.style.backgroundColor = o.cancelButtonColor); {
                var i;
                U() || (i = window.getComputedStyle(t)
                    .getPropertyValue("background-color"), t.style.borderLeftColor = i, t.style.borderRightColor = i)
            }
    ...
    var gt, vt = function(t, e) {
        ...
        Ct = '\n <div aria-labelledby="'.concat(J.title, '" aria-describedby="')
        ...
        .replace(/(^|\n)\s*/g, ""),
        kt = function(t) {
            var e, n, o, i, r, a, c, s, u, l, d, p, f, m, h, g = !!(e = C()) && (e.parentNode.removeChild(e), yt([document.documentElement, document.body], [J["no-backdrop"], J["toast-shown"], J["has-column"]]), !0);
            pt() ? Y("SweetAlert2 requires document to initialize") : ((n = document.createElement("div"))
                .className = J.container, g && vt(n, J["no-transition"]), _(n, Ct), (o = "string" == typeof(i = t.target) ? document.querySelector(i) : i)
                .appendChild(n), r = t, (a = x())
                .setAttribute("role", r.toast ? "alert" : "dialog"), a.setAttribute("aria-live", r.toast ? "polite" : "assertive"), r.toast || a.setAttribute("aria-modal", "true"), c = o, "rtl" === window.getComputedStyle(c)
                .direction && vt(C(), J.rtl), s = A(), u = bt(s, J.input), l = bt(s, J.file), d = s.querySelector(".".concat(J.range, " input")), p = s.querySelector(".".concat(J.range, " output")), f = bt(s, J.select), m = s.querySelector(".".concat(J.checkbox, " input")), h = bt(s, J.textarea), u.oninput = ft, l.onchange = ft, f.onchange = ft, m.onchange = ft, h.oninput = ft, d.oninput = function(t) {
    ...
    function At(t, e, n) {
        var o;
        st(t, n["show".concat((o = e)
            .charAt(0)
            .toUpperCase() + o.slice(1), "Button")], "inline-block"), _(t, n["".concat(e, "ButtonText")]), t.setAttribute("aria-label", n["".concat(e, "ButtonAriaLabel")]), t.className = J[e], z(t, n, "".concat(e, "Button")), vt(t, n["".concat(e, "ButtonClass")])
    }
    function St(t, e) {
        var n, o, i, r, a, c, s, u, l = C();
        l && (n = l, "string" == typeof(o = e.backdrop) ? n.style.background = o : o || vt([document.documentElement, document.body], J["no-backdrop"]), !e.backdrop && e.allowOutsideClick && K('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), i = l, (r = e.position) in J ? vt(i, J[r]) : (K('The "position" parameter is not valid, defaulting to "center"'), vt(i, J.center)), a = l, !(c = e.grow) || "string" != typeof c || (s = "grow-".concat(c)) in J && vt(a, J[s]), z(l, e, "container"), (u = document.body.getAttribute("data-swal2-queue-step")) && (l.setAttribute("data-queue-step", u), document.body.removeAttribute("data-swal2-queue-step")))
    }
    function Et(t, e) {
    ...
    It.text = It.email = It.password = It.number = It.tel = It.url = function(t, e) {
        ...
        var n, o;
        return e.value = t.inputValue, Et(e, t), "MutationObserver" in window && (n = parseInt(window.getComputedStyle(x())
                .width), o = parseInt(window.getComputedStyle(x())
                .paddingLeft) + parseInt(window.getComputedStyle(x())
    ...
    function Mt(t, e) {
        var n, o, i, r, a, c = A()
            .querySelector("#".concat(J.content));
        e.html ? (mt(e.html, c), rt(c, "block")) : e.text ? (c.textContent = e.text, rt(c, "block")) : at(c), n = t, o = e, i = A(), r = Ot.innerParams.get(n), a = !r || o.input !== r.input, Tt.forEach(function(t) {
            var e = J[t],
                n = bt(i, e);
    ...
    function Rt(t, s) {
        ...
        l >= s.progressSteps.length && K("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), s.progressSteps.forEach(function(t, e) {
            var n, o, i, r, a, c = (n = t, o = document.createElement("li"), vt(o, J["progress-step"]), _(o, n), o);
            u.appendChild(c), e === l && vt(c, J["active-progress-step"]), e !== s.progressSteps.length - 1 && (r = s, a = document.createElement("li"), vt(a, J["progress-step-line"]), r.progressStepsDistance && (a.style.width = r.progressStepsDistance), i = a, u.appendChild(i))
        })
    }
    function Ht(t, e) {
        var n, o, i, r, a, c, s, u, l = I();
        z(l, e, "header"), Rt(0, e), n = t, o = e, (r = Ot.innerParams.get(n)) && o.icon === r.icon && B() ? Ft(B(), o) : (_t(), o.icon && (-1 !== Object.keys(X)
                .indexOf(o.icon) ? (i = k(".".concat(J.icon, ".")
                    .concat(X[o.icon])), rt(i), Wt(i, o), Ft(i, o), vt(i, o.showClass.icon)) : Y('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')))),
            function(t) {
                var e = S();
            ...
            }(e), a = e, c = P(), st(c, a.title || a.titleText), a.title && mt(a.title, c), a.titleText && (c.innerText = a.titleText), z(c, a, "title"), s = e, u = R(), _(u, s.closeButtonHtml), z(u, s, "closeButton"), st(u, s.showCloseButton), u.setAttribute("aria-label", s.closeButtonAriaLabel)
    }
    function Nt(t, e) {
        var n, o, i, r;
        n = e, o = x(), it(o, "width", n.width), it(o, "padding", n.padding), n.background && (o.style.background = n.background), Qt(o, n), St(0, e), Ht(t, e), Mt(t, e), ht(0, e), i = e, r = M(), st(r, i.footer), i.footer && mt(i.footer, r), z(r, i, "footer"), "function" == typeof e.didRender ? e.didRender(x()) : "function" == typeof e.onRender && e.onRender(x())
    }
    function Ut() {
        return T() && T()
            .click()
    ...
    var _t = function() {
        ...
        zt = function() {
            for (var t = x(), e = window.getComputedStyle(t)
        ...
        Yt = function(t) {
            return '<div class="'.concat(J["icon-content"], '">')
                .concat(t, "</div>")
        },
        Zt = [],
        Qt = function(t, e) {
            t.className = "".concat(J.popup, " ")
                .concat(wt(t) ? e.showClass.popup : ""), e.toast ? (vt([document.documentElement, document.body], J["toast-shown"]), vt(t, J.toast)) : vt(t, J.modal), z(t, e, "popup"), "string" == typeof e.customClass && vt(t, e.customClass), e.icon && vt(t, J["icon-".concat(e.icon)])
        };
    function $t() {
        var t = x();
        t || bn.fire(), t = x();
    ...
    function Xt() {
        if (oe.timeout) return function() {
            var t = V(),
                e = parseInt(window.getComputedStyle(t)
                    .width);
            t.style.removeProperty("transition"), t.style.width = "100%";
            var n = parseInt(window.getComputedStyle(t)
                    .width),
                o = parseInt(e / n * 100);
    ...
    function ne(t) {
        for (var e in t) te(i = e) || K('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== ce.indexOf(o) && K('The parameter "'.concat(o, '" is incompatible with toasts'))), ee(n = e) && g(n, ee(n));
        var n, o, i
    }
    var oe = {},
        ie = {
        ...
        se = Object.freeze({
            ...
            argsToParams: function(o) {
                ...
                return "object" !== r(o[0]) || w(o[0]) ? ["title", "html", "icon"].forEach(function(t, e) {
                    var n = o[e];
                    "string" == typeof n || w(n) ? i[t] = n : void 0 !== n && Y("Unexpected type of ".concat(t, '! Expected "string" or "Element", got ')
                        .concat(r(n)))
                }) : s(i, o[0]), i
            },
            isVisible: function() {
            ...
            mixin: function(r) {
                return function(t) {
                    ...
                    var n, o, e = (n = i, o = d(), function() {
                        var t, e = u(n);
                        return p(this, o ? (t = u(this)
                            .constructor, Reflect.construct(e, arguments, t)) : e.apply(this, arguments))
                    });
                    function i() {
                    ...
                    return c(i, [{
                        key: "_main",
                        value: function(t) {
                            return f(u(i.prototype), "_main", this)
                                .call(this, s({}, r, t))
                        }
                    }]), i
                }(this)
            ...
            queue: function(t) {
                ...
                return new Promise(function(i) {
                    ! function e(n, o) {
                        n < Zt.length ? (document.body.setAttribute("data-swal2-queue-step", n), r.fire(Zt[n])
                            .then(function(t) {
    ...
    function le() {
        null === tt.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (tt.previousBodyPadding = parseInt(window.getComputedStyle(document.body)
            .getPropertyValue("padding-right")), document.body.style.paddingRight = "".concat(tt.previousBodyPadding + function() {
            var t = document.createElement("div");
    ...
    var fe = function() {
            navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) || x()
                .scrollHeight > window.innerHeight - 44 && (C()
                    .style.paddingBottom = "".concat(44, "px"))
        },
        me = function() {
            var e, t = C();
        ...
        he = function(t) {
            var e = C();
            return t === e || !(ut(e) || "INPUT" === t.tagName || ut(A()) && A()
                .contains(t))
        },
        ge = {
    ...
    function Ae(t) {
        var e, n;
        (e = t)
        .inputValidator || Object.keys(Pe)
            .forEach(function(t) {
                e.input === t && (e.inputValidator = Pe[t])
            }), t.showLoaderOnConfirm && !t.preConfirm && K("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"), t.animation = Q(t.animation), (n = t)
            .target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild) || (K('Target parameter is not valid, defaulting to "body"'), n.target = "body"), "string" == typeof t.title && (t.title = t.title.split("\n")
                .join("<br />")), kt(t)
    }
    function Se(t) {
        var e = C(),
        ...
        var o = window.getComputedStyle(document.body)
            .overflowY;
        Ne(e, n, t), Re(e, n), N() && (He(e, t.scrollbarPadding, o), h(document.body.children)
            .forEach(function(t) {
                t === C() || function(t, e) {
    ...
    function Me(t, e, n) {
        Ot.innerParams.get(t)
            .toast ? an(t, e, n) : (sn(e), un(e), ln(t, e, n))
    }
    var Ve = function(t, e) {
        ...
        Ne = function(t, e, n) {
            vt(t, n.showClass.backdrop), rt(e), vt(e, n.showClass.popup), vt([document.documentElement, document.body], J.shown), n.heightAuto && n.backdrop && !n.toast && vt([document.documentElement, document.body], J["height-auto"])
        },
        Ue = function(t) {
        ...
        ze = function(e, n) {
            ...
            var i = A();
            v(n.inputOptions) || b(n.inputOptions) ? ($t(), y(n.inputOptions)
                .then(function(t) {
                    e.hideLoading(), o(t)
        ...
        Ke = {
            select: function(t, e, i) {
                ...
                e.forEach(function(t) {
                    var e, n = t[0],
                        o = t[1];
                    Array.isArray(o) ? ((e = document.createElement("optgroup"))
                        .label = n, e.disabled = !1, a.appendChild(e), o.forEach(function(t) {
                            return r(e, t[1], t[0])
                        })) : r(a, o, n)
                }), a.focus()
            },
            radio: function(t, e, a) {
                ...
                e.forEach(function(t) {
                    ...
                    _(r, n), r.className = J.label, i.appendChild(o), i.appendChild(r), c.appendChild(i)
                });
        ...
        Ze = function(e, n) {
            ...
            n.inputValidator ? (e.disableInput(), Promise.resolve()
                    .then(function() {
                ...
                .checkValidity() ? $e(e, n, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage))
        },
        Qe = function(t) {
            t.closePopup({
                isDenied: !0,
        ...
        $e = function(e, t, n) {
            t.showLoaderOnConfirm && $t(), t.preConfirm ? (e.resetValidationMessage(), Promise.resolve()
                .then(function() {
        ...
        tn = function(t, e, n) {
            ...
            o.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? en(t, e, o) : "Tab" === e.key ? nn(e, o) : -1 !== [].concat(Je, Xe)
                .indexOf(e.key) ? on(e.key) : -1 !== Ge.indexOf(e.key) && rn(e, o, n)
        },
        en = function(t, e, n) {
            if (!e.isComposing && e.target && t.getInput() && e.target.outerHTML === t.getInput()
                .outerHTML) {
    ...
    s(yn.prototype, vn), s(yn, se), Object.keys(vn)
        .forEach(function(t) {
            yn[t] = function() {
                if (hn) return hn[t].apply(hn, arguments)
            }
        }), yn.DismissReason = $, yn.version = "10.3.0";
    var bn = yn;
